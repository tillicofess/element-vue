...
const handleAvatarUpdate = async () => {
  try {
    ...
    const response = await updateUserAvatar(selectedFile.value!, "http://49.235.164.72:3000/update-avatar");
...
const handleProfileUpdate = async () => {
  try {
    ...
    const response = await updateUserName(username.value, "http://49.235.164.72:3000/update-profile");
    if (response === 1) {
